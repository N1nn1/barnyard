...
public class BarnyardPigAi {
    ...
    public static final UniformInt SNIFFING_COOLDOWN = UniformInt.of(600 * 20, 1800 * 20);
    public static final UniformInt MUD_ROLLING_COOLDOWN = UniformInt.of(90 * 20, 210 * 20);
