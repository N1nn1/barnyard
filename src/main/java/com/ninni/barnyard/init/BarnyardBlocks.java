...
public class BarnyardBlocks {
    ...
    public static final Block THATCH_BLOCK = register("thatch_block", new Block(FabricBlockSettings.of(Material.GRASS, MaterialColor.COLOR_YELLOW).strength(0.25F).sound(SoundType.GRASS)));
